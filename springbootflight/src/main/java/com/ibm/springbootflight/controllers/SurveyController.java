...
import com.ibm.springbootflight.entities.*;
import com.ibm.springbootflight.services.*;
...
public ResponseEntity<Void> updateChoice(@RequestBody Choice choice){
	...
	@GetMapping("/choice/{surveyName}")
	public List<Choice> findChoice(@PathVariable("surveyName") String surveyName){
		return surveyService.findChoice(surveyName);
	}
